...
import com.niaobulashi.javademo.excel.model.AuthorModel;
...
public class ExportTest {
	...
	public void testExportSpecifyFields()throws Exception {
		...
		Workbook workbook = context.createExcel(excelId,stus,null, specifyFields, Boolean.FALSE);
		workbook.write(ops);
		ops.close();
		workbook.close();
	}
